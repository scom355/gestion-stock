...
import iconAdd from './assets/cherpa/add_product_new.png';
...
// BACK OFFICE (DASHBOARD) ICONS - Using updated versions
import iconScannerDash from './assets/cherpa/consulta_new.png';
import iconAddDash from './assets/cherpa/add_product_new.png';
import iconBandejasDash from './assets/cherpa/carne_new.webp';
...
const DashboardIcons = {
  a1: () => <img src={iconScannerDash} alt="Scanner" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />,
...
function App() {
  ...
  const clearSpool = async () => {
    try {
      setTicketSpool([]); // Optimistic immediate UI update
      await fetch(`${API_BASE}/spool`, { method: 'DELETE' });
      fetchData();
    } catch (e) { console.error(e); }
  };

...
const CongeladoPedido = ({ API_BASE, onAddToBucket, color }) => {
    ...
    const fetchCatalog = async () => {
        setIsLoading(true);
        try {
            const res = await fetch(`${API_BASE}/catalog/congelado`);
            if (res.ok) {
    ...
    return (
        <div className="dept-ped-sheet">
            <div className="stock-list-container">
                {isLoading ? (
                    <div className="loading-state">Cargando catálogo... ❄️</div>
...
export default CongeladoPedido;
